...
import com.pm.model.dto.request.LoginRequest;
import com.pm.model.dto.request.SignupRequest;
import com.pm.model.dto.response.JwtResponse;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "project_manager":
					Role modRole = roleRepository.findByName("project_manager")
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(modRole);
